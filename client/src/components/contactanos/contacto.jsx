...
export default function Contacto({proporcional}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 150 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 850 / proporcional}}>
                <div className='' style={{width: '50%', height: 850 / proporcional, paddingTop: 20 / proporcional, paddingBottom: 20 / proporcional}}>
                    <div className='' style={{width: '100%', height: 'auto'}}>
                        ...
                        <div style={{width: '100%', height: 'auto'}}>
                            ...
                            <input 
                                style={{width: '60%', height: 50 / proporcional, fontSize: 20 / proporcional, fontFamily: 'Montserrat, sans-serif', color: 'rgb(101, 154, 172)',
                            ...
                            <input 
                                ...
                                className='form-control'/>
                            <textarea 
                                style={{width: '60%', height: 150 / proporcional, fontSize: 20 / proporcional, fontFamily: 'Montserrat, sans-serif', color: 'rgb(101, 154, 172)',
                                        border: '1px solid rgb(136, 200 200)', background: 'transparent', marginBottom: 20 / proporcional}}
                                value={message}
                                ...
                                placeholder='message'
                                className='form-control'/>
                            <button className='btn' style={{width: '30%', height: 50 / proporcional, background: boton_mensaje ? 'transparent' : '#dbf6ff', 
                ...
                <div className='d-flex justify-content-center' style={{width: '50%', height: 850 / proporcional}}>
                    <img src={image_00} style={{width: 700 / proporcional, height: 850 / proporcional}}/>
                </div>
            </div>
        </div>
    )

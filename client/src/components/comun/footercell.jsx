...
export default function FooterCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
            ...
            <div className='d-flex justify-content-center'div style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
            ...
            <div className='d-90 justify-content-center' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '90%', height: 'auto'}}>
                    <p style={{fontSize: 30 / proporcional, lineHeight: `${32 / proporcional}px`, marginBottom: 50 / proporcional, color: 'white', 
                        cursor: 'default', fontWeight: 500, fontFamily: 'Pacifico, cursive', wordWrap: 'break-word'}}>
                        Contáctanos

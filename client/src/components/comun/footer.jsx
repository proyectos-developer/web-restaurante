...
export default function Footer({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 150 / proporcional, paddingBottom: 150 / proporcional, paddingLeft: 150 / proporcional, paddingRight: 150 / proporcional,
                background: '#008094'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '25%', height: 'auto'}}>
                    <div style={{width: '100%', height: 'auto'}}>
                        ...
                        <div className='d-flex justify-content-start' style={{width: '100%', height: 64 / proporcional, marginBottom: 20 / proporcional}}>
                ...
                <div style={{width: '25%', height: 'auto', padding: 20 / proporcional}}>

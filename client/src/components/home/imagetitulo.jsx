...
export default function ImageTitulo({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 1000 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 1000 / proporcional}}>
                <div style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${image_home})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}/>
                ...
                <div className='position-absolute top-0 start-0' style={{width: '100%', height: 1000 / proporcional, background: 'rgba(39, 39, 39, 0.2)', zIndex: 99}}/>
            </div>
        </div>
    )
}
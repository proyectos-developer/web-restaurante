...
export default function RecomendacionesChef({proporcional, fondo}) {

    return (
        <div style={{width: '100%', height: 1000 / proporcional, paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingLeft: 150 / proporcional, paddingRight: 150 / proporcional,
            ...
            <div style={{width: '100%', height: 700 / proporcional}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    <div className='' style={{width: '22%', height: 'auto'}}>
